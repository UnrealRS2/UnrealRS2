...
ClientData _Client = {
    ...
    .rsa_exponent = "081f390b2cf8ca7039ee507975951d5a0b15a87bf8b3f99c966834118c50fd94d", // pad exponent to an even number (prefix a 0 if needed)
...
int _main_entry(int argc, char **argv) {
